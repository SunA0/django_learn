...
#
#     # topics
#     url(r'^board/(?P<pk>\d+)/$', boards_views.topics, name='topics'),
#     # about
#     url(r'^about/$', boards_views.about, name='about'),
#     # about company
#     url(r'^about/company/$', boards_views.about_company, name='about_company'),
#     # topics new
#     url(r'^board/(?P<pk>\d+)/new/$', boards_views.new_topic, name='new_topic'),
#     # topic post
#     url(r'^board/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/$', boards_views.topic_posts, name='topic_posts'),
#     # post new
#     url(r'^board/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/reply/$', boards_views.reply_topic, name='reply_topic'),
#     # post edit
